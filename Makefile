...
${JOBS0J}: jobj0%: ; @python3 codec.py -f 0 -v stats -r $(R) -c $(LIM) -j -q $*
${JOBS1J}: jobj1%: ; @python3 codec.py -f 1 -v stats -r $(R) -c $(LIM) -j -q $*
${JOBS2J}: jobj2%: ; @python3 codec.py -f 2 -v stats -r $(R) -c $(LIM) -j -q $*
